...
\input{tex/1_intro}
\input{tex/2_architecture}
\input{tex/3_verification}
\input{tex/4_synthesis}
\input{tex/5_physical_design}
\input{tex/6_comparison}
