...
\begin{itemize}
    \item \textbf{Total Area:} 654,006 $\mu m^2$ (consisting of 177,266 standard cells).
    \item \textbf{Timing Performance:} The design comfortably met the 100~MHz constraint, achieving a massive positive slack of \textbf{+5.044 ns} in setup timing. This indicates that the purely combinational ReLU datapath successfully avoided critical path bottlenecks.
    \item \textbf{Power Consumption:} The estimated total power post-synthesis was \textbf{84.6 mW}, distributed as 76.9 mW (91\%) dynamic switching power and 7.7 mW (9\%) leakage power.
\end{itemize}
