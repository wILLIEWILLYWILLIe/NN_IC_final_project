...
create_op_cond -name op -library_file ${::IMEX::libVar}/mmmc/NangateOpenCellLibrary_typical.lib -P 1 -V 1.1 -T 25
...
create_analysis_view -name an -constraint_mode sdc -delay_corner de -latency_file ${::IMEX::dataVar}/mmmc/views/an/latency.sdc
