...
# Generated on: Sat Mar 07 14:04:49 CST 2026 (Sat Mar 07 20:04:49 GMT 2026)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/nn_top/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/nn_top -revised fv_map
...
read_design -enumconstraint  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 ../../frontend/sv/nn_pkg.sv ../../frontend/sv/weight_pkg.sv ../../frontend/sv/fifo.sv ../../frontend/sv/npu_mac.sv ../../frontend/sv/argmax.sv ../../frontend/sv/nn_top.sv
elaborate_design -golden -root {nn_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/nn_top/fv_map.v.gz
elaborate_design -revised -root {nn_top}
...
#add_name_alias fv/nn_top/fv_map.singlebit.original_name.alias.json.gz -revised
